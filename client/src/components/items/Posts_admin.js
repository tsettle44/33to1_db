...
export class PostsA extends Component {
  render() {
    const {
      posts,
      modal,
      ...
      <div>
        ...
        {posts.map((post, i) => (
          <div style={postStyle} key={i}>
            ...
            <Button color="link" onClick={() => this.props.delete(post._id)}>
            ...
            {post.comments.map((comment, c) => (
              <div style={commentStyle} key={c}>
                ...
                <Button
                  color="link"
                  onClick={() => this.props.delete(post._id, comment._id)}
                >
                  <FontAwesomeIcon icon={faTrash} /> Delete
                </Button>
                {comment.comments.map((cc, cID) => (
                  <div style={ccDivStyle} key={cID}>
                    ...
                    <Button
                      color="link"
                      onClick={() =>
                        this.props.delete(post._id, comment._id, cc._id)
                      }
                    >
                      <FontAwesomeIcon icon={faTrash} /> Delete
                    </Button>
